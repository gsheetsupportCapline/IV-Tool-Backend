...
async function updateAppointmentInArray(
  ...
  try {
    console.log("=== REPOSITORY LAYER - updateAppointmentInArray ===");
    ...
    // Use arrayFilters for more efficient update without loading entire document
    console.log("Executing updateOne with arrayFilters...");
    const result = await Appointment.updateOne(
      { officeName: officeName },
      {
        $set: {
          "appointments.$[elem].assignedUser": userId,
          "appointments.$[elem].status": status,
          "appointments.$[elem].completionStatus": completionStatus,
